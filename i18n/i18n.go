...
var I18N = map[string]string{
	...
	"Key: 'UserForm.Name' Error:Field validation for 'Name' failed on the 'required' tag":                         "用户名不可为空",
	"Key: 'UserForm.Email' Error:Field validation for 'Email' failed on the 'required' tag":                       "邮箱不可为空",
	"Key: 'UserForm.Role' Error:Field validation for 'Role' failed on the 'required' tag":                         "角色不可为空",
	"Key: 'PasswordForm.Password' Error:Field validation for 'Password' failed on the 'required' tag":             "密码不可为空",
	"Key: 'PasswordForm.PasswordRepeat' Error:Field validation for 'PasswordRepeat' failed on the 'required' tag": "密码确认不可为空",
